...
- (void)sliderValueDidChange:(UISlider *)sender; {
    [super sliderValueDidChange:(UISlider *)sender];
    ...
    // set the title label
    NSString *titleWithCount = [NSString stringWithFormat:NSLocalizedString(@"Whiskey (%.1f %@)", nil), numberOfWhiskeyGlassesForEquivalentAlcoholAmount, whiskeyText];
